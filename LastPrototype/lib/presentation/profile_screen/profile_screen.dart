                                                            ...
                                                            child: Text(
                                                                ...
                                                                textAlign:
                                                                    TextAlign
                                                                        .left,
                                                                style: AppStyle
                                                                    .txtCantarellRegular12Black90001)),
                                                        Padding(
                                                            padding: getPadding(
                                                                top: 4),
                                                            child: Row(
                                                                  ...
                                                                  Container(
                                                                      ...
                                                                      child: Text(
                                                                          ...
                                                                          textAlign: TextAlign
                                                                              .left,
                                                                          style:
                                                                              AppStyle.txtCantarellRegular10Black90001)),
                                                                  Container(
                                                                      width:
                                                                          getHorizontalSize(
                                                                              47),
                                                                  ...
                                                                  Container(
                                                                      ...
                                                                      child: Stack(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Align(
                                                                                alignment: Alignment.bottomCenter,
                                                                                child: Text("lbl_60kg".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtCantarellRegular10Black90001))
                                                                          ]))
                                                                ])),
                                                        Padding(
                                                            padding: getPadding(
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                            padding:
                                                                                getPadding(left: 22),
                                                                            child: Row(children: [
                                                                              Text("lbl_5".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtCantarellRegular16Black90001),
                                                                              Padding(padding: getPadding(left: 65), child: Text("lbl_5".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtCantarellRegular16Black90001))
                                                                            ])),
                                                                        Padding(
                                                                            padding:
                                                                                getPadding(top: 3),
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                              ...
                                              child: Text("lbl_10_coins2".tr,
                                                  ...
                                                  textAlign: TextAlign.left,
                                                  style: AppStyle
                                                      .txtCantarellRegular10Black90001))
                                        ])),
                                GestureDetector(
                                    onTap: () {
